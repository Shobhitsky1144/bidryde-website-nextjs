  ...
  return (
    <div className='testimonialCard' >
      ...
      <div className='testimonialCardContainer' style={{ paddingTop: '60px' }}>
        ...
        <div  className="review" style={{position:'absolute',bottom:'10px',right:'56px',fontWeight:'300',color:'#000000',fontSize:'13px',letterSpacing:'0.5px'}}>
            source:  {data.name=="Pasam Sunny" ?
           
           <Image
           src={assets.images.testimonials.appstore}
         style={{marginTop:0,marginBottom:0,width:'18px',height:'18px',position:'absolute',verticalAlign:'middle',top:'0px'}}
           alt='testimonial icon'
           width={18}
           height={18}
         ...
         />
            :<svg width="13" height="13" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg" style={{margin:'0 2px',verticalAlign:'middle'}}>
...
{data.name=="Pasam Sunny"?<span style={{lineHeight:'19px',paddingLeft:'22px',fontSize:'13px',color:'#303030',fontWeight:'400',letterSpacing:'0.5px'}}>App Store</span>:<span style={{paddingLeft:'',fontSize:'13px',color:'#303030',fontWeight:'400',letterSpacing:'0.5px'}}>Play Store</span>}
          </div>
      </div>
    </div>
  );
