...
const StepsToBid = () => {
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      // Set car size depending on screen
          ...
          {isMobile ? (
            ...
            >
              <path
                ...
                stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="36 36"
              />
              <image
                id="car"
            ...
            <svg
              ...
              width="697"
              height="1758"
              viewBox="0 0 697 1758"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                id="path1"
                d="M352.002 1.5C506.668 52 786.9 250.8 664.5 488C419.833 615.667 -55.2983 900.7 7.50173 1173.5C219.669 1235.33 650.803 1438.5 678.003 1756.5"
                stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="36 36"
          ...
          {cardsInfo.map((info, index) => (
            <div
              className={`cardcontainer ${
                index % 2 !== 0 ? "rightAlign" : "leftAlign"
              }`}
              key={index}
            >
              ...
              {index == 1 ? (
                ...
                >
                  <g filter="url(#filter0_d_1_20168)">
                    <path
                      d="M-106 110.727L113.31 50.1515C126.008 46.6443 139.619 49.6138 149.702 58.0913L260.895 151.581C285.546 172.306 276.846 212.179 245.803 220.753L-52.8273 303.237L-106 110.727Z"
                      fill="#276EBC"
                    />
                  </g>
                  <defs>
                    ...
                    >
                      ...
                      <feBlend
                        mode="normal"
                        in2="BackgroundImageFix"
                        result="effect1_dropShadow_1_20168"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_1_20168"
                        result="shape"
                      />
                    </filter>
                  </defs>
